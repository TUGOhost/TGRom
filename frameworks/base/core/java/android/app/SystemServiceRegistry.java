...
final class SystemServiceRegistry {
    ...
    static {
        ...
        registerService(Context.TGROM_SERVICE,TGRomManager.class,
                new CachedServiceFetcher<TGRomManager>(){
                    @Override
                    public TGRomManager createService(ContextImpl ctx){
                        IBinder b = ServiceManager.getService(Context.TGROM_SERVICE);
                        return new TGRomManager(ctx,ITGRom.Stub.asInterface(b));
                    } });
